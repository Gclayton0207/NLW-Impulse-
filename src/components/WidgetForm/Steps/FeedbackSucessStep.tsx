...
export function FeedbackSucessStep({onFeedbackRestartedRequest}:FeedbackTypeStepProps) {
  return (
    <>
      <header>
        <CloseButton />
      ...
      <div className="flex flex-col items-center py-10 w-[304px]">
        ...
        focus:border-brand-500 focus:ring-brand-500 focus:outline-none focus:ring-1 resize-none">
            Quero enviar outro
        </button>
      </div>
    </>
